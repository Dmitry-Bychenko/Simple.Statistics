...
namespace Simple.Statistics.Distributions {
  ...
  //
  /// <summary>
  /// Empirical Distribution (based on provided data sample)
  /// </summary>
  //
  //-------------------------------------------------------------------------------------------------------------------

  public sealed class EmpiricalDistribution : ContinuousDistribution {
    #region Private Data
    ...
    /// Mean
    /// </summary>
    protected override double CoreMean() => m_Sx / m_RawSample.Count;

    /// <summary>
    /// Variance
    /// </summary>
    protected override double CoreVariance() => m_Sx2 / m_RawSample.Count - m_Sx * m_Sx / m_RawSample.Count / m_RawSample.Count;
    ...
    public EmpiricalDistribution(IEnumerable<double> sample) {
      if (sample is null)
    ...
    /// To String 
    /// </summary>
    public override string ToString() => $"Empirical distribution";
